...
-- CreateIndex
CREATE INDEX "idx_document_embeddings_isDeleted" ON "document_embeddings"("isDeleted");

-- CreateIndex
CREATE INDEX "idx_document_embeddings_createdAt" ON "document_embeddings"("createdAt");
